...
public class Data {
    public static List<Student> getStudents() {
        ...
        students.add(new Student("5", "Hai", "6", ".Net"));
        students.add(new Student("6", "An", "3", ".Net"));
        students.add(new Student("7", "Huong", "5", "Java"));
        students.add(new Student("8", "Trang", "4", "Java"));
        students.add(new Student("9", "Linh", "1", "C/C++"));
        students.add(new Student("10", "Thao", "2", "C/C++"));
        return students;
    }
}
